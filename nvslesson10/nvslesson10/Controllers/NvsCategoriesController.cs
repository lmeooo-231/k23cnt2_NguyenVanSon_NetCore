...
namespace nvslesson10.Controllers
{
    ...
    {
        private readonly NvsLesson10dbContext _context;

        public NvsCategoriesController(NvsLesson10dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> NvsCreate([Bind("CateId,CateName,CateStatus")] NvsCategory category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CateId,CateName,CateStatus")] NvsCategory category)
        {
