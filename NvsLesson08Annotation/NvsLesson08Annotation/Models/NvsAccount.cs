...
namespace NvsLesson08Annotation.Models
{
    public class NvsAccount
    {
        [Key]
        [Display(Name = "Mã")]
        public int NvsId { get; set; }
        ...
        public string NvsPhone { get; set; }

        [Display(Name = "Địa chỉ thường trú")]
        [Required(ErrorMessage = "Địa chỉ không được để trống")]
        [StringLength(35, ErrorMessage = "Địa chỉ không vượt quá 35 ký tự")]
        public string NvsAddress { get; set; }

        [Display(Name = "Ảnh đại diện")]
        public string NvsAvatar { get; set; }
        ...
        public string NvsGender { get; set; }
        ...
        public string NvsFacebook { get; set; }
    }
}